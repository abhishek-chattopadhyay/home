...
<div class="home-intro" style="display: flex; flex-wrap: wrap; align-items: flex-start; gap: 2rem;">

  <!-- Photo on the left -->
  <div class="home-photo-container" style="flex: 1 1 250px; max-width: 250px;">
    <img src="/data/formal-photo-1-canva.jpg" alt="Abhishek Chattopadhyay" class="home-photo" style="width: 100%; border-radius: 12px; object-fit: cover;">
  </div>

  <!-- Text on the right -->
  <div class="home-text" style="flex: 2 1 400px; min-width: 250px;">
    ...
    <p class="home-contact" style="margin-top: 1rem; font-weight: bold;">
